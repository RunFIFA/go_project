...
func (x *TestModel) GetUserId() int32 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *TestModel) GetUserName() string {
	if x != nil {
		return x.UserName
	}
	return ""
...
func (x *TestModel) GetUserPwd() string {
	if x != nil {
		return x.UserPwd
	}
	return ""
...
var file_Models_proto_rawDesc = []byte{
	...
	0x0a, 0x09, 0x54, 0x65, 0x73, 0x74, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x12, 0x17, 0x0a, 0x07, 0x75,
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x75, 0x73, 0x65, 0x72, 0x50, 0x77, 0x64, 0x42, 0x0c, 0x5a, 0x0a,
