...
type TestReponse struct {
	...
	Data    []*TestModel `protobuf:"bytes,3,rep,name=data,proto3" json:"data,omitempty"`
}

func (x *TestReponse) Reset() {
	*x = TestReponse{}
...
func (x *TestReponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TestReponse) ProtoMessage() {}

func (x *TestReponse) ProtoReflect() protoreflect.Message {
	mi := &file_TestService_proto_msgTypes[0]
...
// Deprecated: Use TestReponse.ProtoReflect.Descriptor instead.
func (*TestReponse) Descriptor() ([]byte, []int) {
	return file_TestService_proto_rawDescGZIP(), []int{0}
}

func (x *TestReponse) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
func (x *TestReponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *TestReponse) GetData() []*TestModel {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *TestRequest) GetSize() int32 {
	if x != nil {
		return x.Size
	}
	return 0
...
var file_TestService_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x5f, 0x0a, 0x0b, 0x54, 0x65, 0x73, 0x74, 0x52, 0x65, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	...
	,
...
var file_TestService_proto_goTypes = []interface{}{
	(*TestReponse)(nil), // 0: TestReponse
	(*TestRequest)(nil), // 1: TestRequest
	(*TestModel)(nil),   // 2: TestModel
}
var file_TestService_proto_depIdxs = []int32{
	2, // 0: TestReponse.data:type_name -> TestModel
	1, // 1: TestService.TestReg:input_type -> TestRequest
	0, // 2: TestService.TestReg:output_type -> TestReponse
